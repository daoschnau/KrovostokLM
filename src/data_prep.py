...
def main():
    ...
    parser.add_argument("--input", type=str, default="../data/raw", help="Директория с .txt файлами")
    parser.add_argument("--output", type=str, default="../data/processed/dataset.parquet", help="Путь для сохранения датасета")
